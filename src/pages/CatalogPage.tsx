...
const CatalogPage = () => {
  ...
  const products = [
    ...
    {
      id: 4,
      name: "IP-відеокамера 4Mp TVT TD-9541E3 (D/PE/AR2) Black f=2.8mm",
      category: "Відеоспостереження",
      price: "2,100 грн",
      image: "/IP-відеокамера 4Mp TVT TD-9541E3.png",
      features: ["4Mp роздільність", "PoE живлення", "Аналітика руху"],
      rating: 4.7,
      inStock: false
    },
    {
      id: 5,
      name: "IP-відеокамера 2Mp TVT TD-9423A3-LR f=7-22mm з розпізнаванням номерів",
      category: "Відеоспостереження",
      price: "4,500 грн",
      image: "/IP-відеокамера з розпізнаванням номерів TVT TD-9423A3-LR.png",
      features: ["Розпізнавання номерів", "Варіофокальний об'єктив", "Інфрачервона підсвітка"],
      rating: 4.8,
      inStock: true
    },
    {
      id: 6,
      name: "Трансформатор Trinix 40 Вт",
      category: "Енергосистеми",
      price: "450 грн",
      image: "/Трансформатор Trinix 40 Вт.png",
      features: ["40 Вт потужність", "Стабільна напруга", "Компактний розмір"],
      rating: 4.5,
      inStock: true
    },
    {
      id: 7,
      name: "Блок акумуляторних батарей для UPS KRF-TB192V Kraft",
      category: "Енергосистеми",
      price: "8,500 грн",
      image: "/Блок акумуляторних батарей KRF-TB192V Kraft.png",
      features: ["192V напруга", "Довготривала робота", "Швидка заміна"],
      rating: 4.6,
      inStock: true
    },
    {
      id: 8,
      name: "Блок живлення KRF-1220(18CH) BOX Kraft",
      category: "Енергосистеми",
      price: "2,200 грн",
      image: "/Блок живлення KRF-1220(18CH) BOX Kraft.png",
      features: ["18 каналів", "12V вихід", "Захист від перевантаження"],
      rating: 4.4,
      inStock: true
    }
  ];

  const categories = ["Всі", "Домофони", "Відеоспостереження", "Контроль доступу", "Енергосистеми"];
